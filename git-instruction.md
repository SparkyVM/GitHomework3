...
*Зафиксировать изменения можно двумя способами:*

1. git add file_name.md - сохранение версии

git commit -m "message" - добавление сообщения

2. git commit -am "message" - сохранение версии и добавление сообщения

**Переход на другую версию**

* git checkout <id> - переход к ранее сохраненной версии

* git checkout master - вернуться к последней версии

*Проверка наличия изменений по сравнению с актуальной версией*
...
git branch name - переход на ветку
